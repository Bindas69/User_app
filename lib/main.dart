...
import 'package:booking_system_flutter/services/remote_config_service.dart'; // Add this import
...
import 'package:firebase_remote_config/firebase_remote_config.dart'; // Add this import
...
void main() async {
  ...
  await Firebase.initializeApp().then((value) async {
    ...
    // Initialize Remote Config after Firebase is initialized
    try {
      await RemoteConfigService.instance.initialize();
      RemoteConfigService.instance.listenToUpdates();
