import 'package:booking_system_flutter/services/remote_config_service.dart';
                  ...
                  if (appStore.isLoggedIn)
                    Container(
                      ...
                      child: Column(
                        ...
                        // if (appStore.isLoggedIn)
                        //   SettingSection(
                        //     title: Text('E-COMMERCE SHOP', style: boldTextStyle(color: primaryColor)),
                        ...
                        //     ),
                        //     divider: Offstage(),
                        //     headerPadding: EdgeInsets.only(top: 14, bottom: 14, left: 16, right: 14),
                        //     items: [
                        //       SettingItemWidget(
                        //         decoration: boxDecorationDefault(
                        ...
                        //         ),
                        //         leading: Icon(Icons.store, color: context.iconColor, size: SETTING_ICON_SIZE),
                        //         title: 'Visit Shop',
                        //         titleTextStyle: boldTextStyle(size: 12),
                        //         padding: EdgeInsets.symmetric(vertical: 20, horizontal: 16),
                        //         onTap: () {
                        //            commonLaunchUrl('https://your-ecommerce-shop.com', launchMode: LaunchMode.externalApplication);
                                  
                        //         },
                        //       ),
                        //     ],
                        //   ).paddingOnly(left: 16, right: 16, top: 30, bottom: 10),
                        // Then in your build method, replace the E-commerce section with:
// if (appStore.isLoggedIn && RemoteConfigService.instance.isEcommerceEnabled)
//   SettingSection(
//     title: Text('E COMMERCE SHOP', style: boldTextStyle(color: primaryColor)),
//     headingDecoration: boxDecorationDefault(
//       color: context.primaryColor.withAlpha(25),
...
//             toast('Shop is currently under maintenance. Please try again later.');
//             return;
//           }
       if (appStore.isLoggedIn && RemoteConfigService.instance.isEcommerceEnabled)
  SettingSection(
    title: Text(language.lblEcommerceShop.toUpperCase(), style: boldTextStyle(color: primaryColor)),
    ...
    items: [
      SettingItemWidget(
        leading: Icon(Icons.store, color: context.iconColor, size: SETTING_ICON_SIZE),
        title: language.lblVisitShop,
        titleTextStyle: boldTextStyle(size: 12),
        onTap: () {
          if (RemoteConfigService.instance.isMaintenanceMode) {
            toast(language.lblUnderMaintenance);  // You already have Urdu for maintenance
            return;
          }
